<template>
	<section>
		...
		<div>
			<h2>Is this available for free?</h2>
			<p>
		...
		<div>
			<h2>Privacy and personal data collection</h2>
			<p>
...
div:nth-of-type(2) p:last-of-type {
	display: flex;
	align-items: center;
	justify-content: center;
}

div:nth-of-type(2) p:last-of-type a.button {
	width: 12em;
	height: 3em;
}
